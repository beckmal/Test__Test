...
# ============================================================================
# Figure 4: White Balance UI (Balance Viewer)
# ============================================================================
println("Generating Figure 4: White Balance UI (Balance Viewer)...")

# Load Balance UI module
include("Load_Sets__BalanceUI.jl")

const balance_result = create_balance_figure(sets, input_type, raw_output_type; test_mode=true)
const balance_fig = balance_result.figure
...
println("Registering mousebutton workaround on balance_fig...")
...
Bas3GLMakie.GLMakie.save("dataset_whitebalance_ui.png", balance_fig)
println("Saved white balance UI to dataset_whitebalance_ui.png")
...
println("  4. White Balance UI (Before/After comparison with RGB histograms)")
println("\nWhite Balance UI window is open. Close it manually when done.")
println("=== Done ===")
